defmodule SchwabbleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SchwabbleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SchwabbleWeb.Gettext, "errors", msg, opts)
    end
  end
